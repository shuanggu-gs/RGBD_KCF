function out = get_cn_features(im_patch, features_type, w2c)

% out = get_cn_feature(im_patch, features, w2c)
%
...
for i = 1:num_valid_features
    used_features(i) = any(strcmpi(valid_features{i}, features_type));
end
